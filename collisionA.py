...
pg.display.set_caption("Pygame Button Example")
...
def open_second_window():
    ...
    class Object(pg.sprite.Sprite):
        ...
        def update(self):
            ...
            self.rect.x, self.rect.y = player.blit_pos.x + (
                        self.left - global_pos[0]) + player.w / 2, player.blit_pos.y + (
    ...
    while game_run:
        ...
        text_surface = my_font.render(
            f"Score: {data}, Global: {global_pos}, Speed: {player.speed}, Mouse: {pg.mouse.get_pos()} Map:{map.w}  ",
...
while True:
    ...
    # Draw the button
    button_rect = pg.draw.rect(screen, BUTTON_COLOR, (WIDTH // 2 - BUTTON_WIDTH // 2, HEIGHT // 2 - BUTTON_HEIGHT // 2, BUTTON_WIDTH, BUTTON_HEIGHT))
